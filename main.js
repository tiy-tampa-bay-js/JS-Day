...
var aFour  = (names.reverse()[0] === 'Mary'); // Don't forget to reference the documentation when you're confused by a method. https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/reverse
...
for (var number = 0; number <= 18; number = number + 2)
  console.log(number);
